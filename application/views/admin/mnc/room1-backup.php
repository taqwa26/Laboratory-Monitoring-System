                      ...
                      <table cellpadding="10">
                        <tr>
                          ...
                          <!-- <input class="form-check-input pin" type="checkbox" data-toggle="toggle" data-on="D3 On" data-off="D3 OFF" value="D3"> -->
                            <?php echo form_open("admin/room1/updstatus"); ?>
                              <div class="form-group">
                                <input type="hidden" name="input_status" value="<?php if ($status->sensor_1r1==1){echo "0";}else{echo "1";} ?>" />
                              </div>
                              <!-- <input class="btn <?php if ($status->sensor_1r1==1){echo "btn-success";}else{echo "btn-danger";} ?>" type="submit" name="submit" value="<?php if ($status->sensor_1r1==1){echo "ON";}else{echo "OFF";} ?>" /> -->
                              <input class="form-check-input pin" type="checkbox" <?php if ($status->sensor_1r1==1){echo "checked";}?> value="<?php if ($status->sensor_1r1==1){echo "1";}else{echo "0";} ?>" onclick="if(this.checked){this.form.submit()}else{this.form.submit()}">
                            <?php echo form_close(); ?>
                          </td>
                        </tr>
                        <tr>
