...
class Monlab2_model extends CI_Model
{
	...
	{    
		$data = array(      
			"sensor_1r2" => $this->input->post('input_status'),       
		);        
	...
	{    
		$data = array(      
			"sensor_2r2" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_3r2" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_4r2" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_5r2" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_6r2" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
