...
class Monlab4_model extends CI_Model
{
	...
	{    
		$data = array(      
			"sensor_1r4" => $this->input->post('input_status'),       
		);        
	...
	{    
		$data = array(      
			"sensor_2r4" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_3r4" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_4r4" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_5r4" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
	...
	{    
		$data = array(      
			"sensor_6r4" => $this->input->post('input_status'),       
		);        
		$this->db->update('status', $data); // Untuk mengeksekusi perintah update data
	}
